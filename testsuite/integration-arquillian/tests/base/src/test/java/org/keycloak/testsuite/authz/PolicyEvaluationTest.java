...
public class PolicyEvaluationTest extends AbstractAuthzTest {
    ...
    public static void testCheckUserAttributes(KeycloakSession session) {
        ...
        builder.append("if (attributes.size() == 5 && attributes.containsKey('a1') && attributes.containsKey('a2') && attributes.get('a1').size() == 2 && attributes.get('a2').get(0).equals('3')) { $evaluation.grant(); }");
